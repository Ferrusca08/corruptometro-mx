...
officials.push(
    ...
    funcionarios:'Filtración de audios en 2022 donde discute con su colaborador más cercano, Juan Ramos, un proyecto de resolución que discutiría la Corte con el entonces ministro Alberto Pérez Dayán, en medio del caso Lozoya. También enfrentó conflicto documentado con el entonces consejero jurídico de la Presidencia, Julio Scherer Ibarra.',
    deuda:'Sin monto de daño patrimonial directo documentado; los señalamientos son de uso indebido de la institución, no de desvío de recursos.',
    denuncias:'Caso ampliamente documentado: persiguió penalmente a su excuñada Laura Morán Servín y a su sobrina política Alejandra Cuevas por la muerte de su hermano Federico (2015), acusándolas de "homicidio por omisión" y logrando que Cuevas pasara casi 2 años presa antes de que la SCJN la liberara. También fue señalado por presunto plagio académico en al menos dos libros usados como soporte para su ingreso al Sistema Nacional de Investigadores nivel III.',
    evasion:'Renunció a la FGR en noviembre de 2025, más de dos años antes de completar su periodo de nueve años, luego de que trascendieran filtraciones de casos sensibles para el gobierno federal. Fue inmediatamente propuesto por la presidenta Sheinbaum como embajador, cargo que asumió el 26 de enero de 2026.',
    nepotismo:'Usó su cargo como Fiscal General para reabrir y perseguir penalmente a familiares directos de su propia esfera personal (la pareja y la hija de su hermano fallecido), en un caso que la propia Corte calificó como carente de fundamento legal.'},
    timeline:[{year:'2019',event:'Asume como primer Fiscal General de la República bajo el nuevo esquema autónomo, cargo con periodo de 9 años'},{year:'2020',event:'Bajo su gestión se reabre el caso de la muerte de su hermano; Alejandra Cuevas es encarcelada'},{year:'2022',event:'Marzo: SCJN libera a Cuevas y cancela orden de aprehensión contra Morán. Se filtran audios sobre el caso Lozoya con un ministro de la Corte. Comparece en el Senado sin cuestionamientos.'},{year:'2025',event:'Noviembre: renuncia a la FGR más de dos años antes de terminar su periodo, en medio de filtraciones de casos sensibles'},{year:'2026',event:'Enero: asume como embajador de México en el Reino Unido'}],
    sources:[{label:'El Universal — Polémicas FGR',url:'https://www.eluniversal.com.mx/nacion/polemicas-que-rodean-a-gertz-manero-como-titular-de-la-fgr-filtracion-de-audios-un-cheque-y-el-rancho-izaguirre/'},{label:'Infobae — Gestión completa',url:'https://www.infobae.com/mexico/2025/11/28/asi-fue-la-gestion-de-gertz-manero-al-frente-de-la-fgr-entre-momentos-de-tension-con-presidencia-y-severas-criticas/'},{label:'Milenio — Renuncia y embajada',url:'https://www.milenio.com/politica/caso-gertz-manero-momentos-mas-polemicos-del-fiscal-renuncio-fgr'}]}
);
...
officials.push(
    ...
    funcionarios:'Analistas documentaron acusaciones de sobornos por un millón de dólares para convocar a sesiones legislativas "a modo" antes de las elecciones, en el contexto del intento de ampliar su mandato.',
    deuda:'Una propiedad que el propio Bonilla reconoció como suya en 2019 registraba un adeudo de 20 años de impuesto predial sin pagar, según documentó el semanario ZETA. Su gobierno fue señalado por "moches" y desvío de recursos públicos, además de dejar obras inconclusas y litigios acumulados.',
    denuncias:'Documentado extensamente por SinEmbargo, Proceso y ZETA. Fue señalado por su propia sucesora, la gobernadora Marina del Pilar Ávila, de estar detrás de la filtración de conversaciones privadas de ella con presuntos agentes estadounidenses.',
    evasion:'Impulsó la llamada "Ley Bonilla" para ampliar su propio mandato de 2 a 5 años mediante una reforma constitucional local, impuesta con la mayoría que tenía en el Congreso estatal; la SCJN la declaró inconstitucional por unanimidad en 2020, anulando la ampliación.',
    nepotismo:'Su gobierno ayudó a que la Universidad Autónoma de Baja California saldara su deuda con el estado en circunstancias señaladas como parte de la red de favores políticos de su administración.'},
    timeline:[{year:'2019',event:'Asume gubernatura de Baja California en noviembre. Un mes después, es denunciado ante la FGR por corrupción y cohecho.'},{year:'2020',event:'Impulsa la "Ley Bonilla" para ampliar su mandato de 2 a 5 años. La SCJN la declara inconstitucional por unanimidad.'},{year:'2021',event:'Termina su gestión el 31 de octubre'},{year:'2023',event:'Deja Morena y se une al PT'},{year:'2026',event:'Marzo: un juez lo vincula a proceso por peculado, abuso de autoridad y uso indebido de atribuciones (caso Next Energy). Julio: su sucesora lo acusa de filtrar conversaciones privadas suyas.'}],
    sources:[{label:'Infobae — Vinculación a proceso',url:'https://www.infobae.com/mexico/2026/03/24/de-cercano-a-amlo-a-acusado-de-peculado-y-abuso-de-autoridad-la-polemica-trayectoria-de-jaime-bonilla-exgobernador-de-baja-california/'},{label:'Expansión Política — Caso Next Energy',url:'https://politica.expansion.mx/estados/2026/03/25/jaime-bonilla-exgobernador-morenista-vinculado-proceso'},{label:'SinEmbargo — Herencia maldita',url:'https://www.sinembargo.mx/3972703/baja-california-jaime-bonilla-la-herencia-maldita/'},{label:'Nación321 — Dos gobernadores, polémicas',url:'https://www.nacion321.com/estados/2026/07/15/baja-california-2-gobernadores-y-polemicas-que-han-ensombrecido-a-la-4t/'},{label:'Border Hub — Denuncia FGR cohecho',url:'https://bordercenter.substack.com/p/denuncian-ante-fgr-a-gobierno-de'}]}
);


officials.push(
    {id:385,name:'Miguel Ángel Yunes Márquez',role:'Senador de la República',party:'MORENA',state:'Veracruz',level:'federal',active:true,status:'en_funciones',lastVerified:'2026-07-20',
    scores:{sentencias:5,fiscalizacion:6,funcionarios:5,deuda:3,denuncias:10,evasion:5,nepotismo:5},
    breakdown:{sentencias:'Sin proceso penal formal en México. Aparece nombrado en reportes periodísticos de mayo de 2026 sobre más de cien políticos, funcionarios y operadores mexicanos bajo distintas líneas activas de investigación en Estados Unidos.',
    fiscalizacion:'Sin hallazgos de fiscalización financiera formal publicados.',
    funcionarios:'Hijo del exgobernador de Veracruz Miguel Ángel Yunes Linares, con una trayectoria familiar de más de dos décadas en cargos públicos veracruzanos y federales.',
    deuda:'Sin monto de daño patrimonial documentado públicamente.',
    denuncias:'Nombrado explícitamente en investigación periodística de Los Ángeles Press (mayo 2026) sobre políticos mexicanos bajo señalamiento de agencias estadounidenses por narcotráfico, lavado de dinero, contrabando de combustible y vínculos con organizaciones criminales. Washington no divulga los motivos específicos de cada señalamiento, según el propio reportaje.',
    evasion:'Mantiene el cargo de senador con fuero pese a los señalamientos periodísticos.',
    nepotismo:'Hijo de un exgobernador con red política familiar extensa en Veracruz (su hermano también ha ocupado cargos de elección popular).'},
    timeline:[{year:'2024',event:'Asume como senador de la República'},{year:'2026',event:'Mayo: nombrado en reportaje sobre políticos mexicanos bajo señalamiento de agencias de EE.UU.'}],
    sources:[{label:'Los Ángeles Press — Agencias de EE.UU. cercan al poder político',url:'https://losangelespress.org/investigaciones/2026/may/12/agencias-de-eeuu-cercan-al-poder-politico-mexicano-por-nexos-criminales-15147.html'}]},

    {id:386,name:'José Luis Dagnino',role:'Presidente Municipal de San Felipe, Baja California',party:'Sin dato',state:'Baja California',level:'municipal',active:true,status:'en_funciones',lastVerified:'2026-07-20',
    scores:{sentencias:5,fiscalizacion:5,funcionarios:3,deuda:3,denuncias:9,evasion:4,nepotismo:2},
    breakdown:{sentencias:'Sin proceso penal formal. Nombrado en reportaje periodístico de mayo de 2026 sobre mexicanos bajo señalamiento de autoridades estadounidenses.',
    fiscalizacion:'Sin hallazgos de fiscalización financiera formal publicados.',
    funcionarios:'Sin red de funcionarios adicional documentada en este caso.',
    deuda:'Sin monto de daño patrimonial documentado.',
    denuncias:'Nombrado explícitamente entre los alcaldes en funciones bajo observación o señalamiento de agencias de EE.UU. por posibles restricciones migratorias o cancelaciones de visa relacionadas con investigaciones de narcotráfico, corrupción o lavado de dinero.',
    evasion:'Mantiene el cargo pese al señalamiento.',
    nepotismo:'Sin datos adicionales documentados.'},
    timeline:[{year:'2026',event:'Mayo: nombrado en reportaje sobre alcaldes fronterizos bajo señalamiento de agencias de EE.UU.'}],
    sources:[{label:'Los Ángeles Press',url:'https://losangelespress.org/investigaciones/2026/may/12/agencias-de-eeuu-cercan-al-poder-politico-mexicano-por-nexos-criminales-15147.html'}]},

    {id:387,name:'Óscar Eduardo Castro Castro',role:'Presidente Municipal de Puerto Peñasco, Sonora',party:'Sin dato',state:'Sonora',level:'municipal',active:true,status:'en_funciones',lastVerified:'2026-07-20',
    scores:{sentencias:5,fiscalizacion:5,funcionarios:3,deuda:3,denuncias:9,evasion:4,nepotismo:2},
    breakdown:{sentencias:'Sin proceso penal formal. Nombrado en reportaje periodístico de mayo de 2026 sobre mexicanos bajo señalamiento de autoridades estadounidenses.',
    fiscalizacion:'Sin hallazgos de fiscalización financiera formal publicados.',
    funcionarios:'Sin red de funcionarios adicional documentada en este caso.',
    deuda:'Sin monto de daño patrimonial documentado.',
    denuncias:'Nombrado explícitamente entre los alcaldes en funciones bajo observación o señalamiento de agencias de EE.UU., en un municipio turístico fronterizo de Sonora.',
    evasion:'Mantiene el cargo pese al señalamiento.',
    nepotismo:'Sin datos adicionales documentados.'},
    timeline:[{year:'2026',event:'Mayo: nombrado en reportaje sobre alcaldes fronterizos bajo señalamiento de agencias de EE.UU.'}],
    sources:[{label:'Los Ángeles Press',url:'https://losangelespress.org/investigaciones/2026/may/12/agencias-de-eeuu-cercan-al-poder-politico-mexicano-por-nexos-criminales-15147.html'}]},

    {id:388,name:'Norma Alicia Bustamante Martínez',role:'Presidenta Municipal de Mexicali, Baja California',party:'Sin dato',state:'Baja California',level:'municipal',active:true,status:'en_funciones',lastVerified:'2026-07-20',
    scores:{sentencias:5,fiscalizacion:5,funcionarios:3,deuda:3,denuncias:9,evasion:4,nepotismo:2},
    breakdown:{sentencias:'Sin proceso penal formal. Nombrada en reportaje periodístico de mayo de 2026 sobre mexicanos bajo señalamiento de autoridades estadounidenses.',
    fiscalizacion:'Sin hallazgos de fiscalización financiera formal publicados.',
    funcionarios:'Sin red de funcionarios adicional documentada en este caso.',
    deuda:'Sin monto de daño patrimonial documentado.',
    denuncias:'Nombrada explícitamente entre los alcaldes en funciones bajo observación o señalamiento de agencias de EE.UU., como titular de uno de los municipios fronterizos más grandes del país.',
    evasion:'Mantiene el cargo pese al señalamiento.',
    nepotismo:'Sin datos adicionales documentados.'},
    timeline:[{year:'2026',event:'Mayo: nombrada en reportaje sobre alcaldes fronterizos bajo señalamiento de agencias de EE.UU.'}],
    sources:[{label:'Los Ángeles Press',url:'https://losangelespress.org/investigaciones/2026/may/12/agencias-de-eeuu-cercan-al-poder-politico-mexicano-por-nexos-criminales-15147.html'}]},

    {id:389,name:'Mario Alberto López Hernández',role:'Diputado Federal',party:'PVEM',state:'Federal',level:'federal',active:true,status:'en_funciones',lastVerified:'2026-07-20',
    scores:{sentencias:5,fiscalizacion:5,funcionarios:3,deuda:3,denuncias:9,evasion:5,nepotismo:2},
    breakdown:{sentencias:'Sin proceso penal formal. Nombrado en reportaje periodístico de mayo de 2026 sobre mexicanos bajo señalamiento de autoridades estadounidenses.',
    fiscalizacion:'Sin hallazgos de fiscalización financiera formal publicados.',
    funcionarios:'Sin red de funcionarios adicional documentada en este caso.',
    deuda:'Sin monto de daño patrimonial documentado.',
    denuncias:'Nombrado explícitamente entre los legisladores en funciones bajo observación o señalamiento de agencias de EE.UU. por posibles vínculos con estructuras criminales.',
    evasion:'Mantiene el cargo con fuero pese al señalamiento.',
    nepotismo:'Sin datos adicionales documentados.'},
    timeline:[{year:'2026',event:'Mayo: nombrado en reportaje sobre legisladores federales bajo señalamiento de agencias de EE.UU.'}],
    sources:[{label:'Los Ángeles Press',url:'https://losangelespress.org/investigaciones/2026/may/12/agencias-de-eeuu-cercan-al-poder-politico-mexicano-por-nexos-criminales-15147.html'}]},

    {id:390,name:'Gabriela Osorio',role:'Alcaldesa de Tlalpan, Ciudad de México',party:'MORENA',state:'Ciudad de México',level:'municipal',active:true,status:'en_funciones',lastVerified:'2026-07-20',
    scores:{sentencias:3,fiscalizacion:5,funcionarios:2,deuda:3,denuncias:8,evasion:3,nepotismo:2},
    breakdown:{sentencias:'Sin proceso penal.',
    fiscalizacion:'Investigada por el Instituto Electoral de la Ciudad de México (IECM) dentro de 9 procedimientos especiales sancionadores en sustanciación.',
    funcionarios:'Sin red de funcionarios documentada en este caso específico.',
    deuda:'Sin daño patrimonial documentado; los señalamientos son de naturaleza electoral y de uso de programas sociales.',
    denuncias:'Nombrada por La Jornada (julio 2026) entre las alcaldesas investigadas por presunto uso de recursos públicos, promoción personalizada y uso indebido de programas sociales con fines electorales.',
    evasion:'Sin evasión documentada.',
    nepotismo:'Sin datos adicionales documentados.'},
    timeline:[{year:'2026',event:'Julio: IECM confirma investigación en su contra por uso indebido de programas sociales y promoción personalizada'}],
    sources:[{label:'La Jornada — IECM investiga a funcionarios',url:'https://www.jornada.com.mx/2026/07/04/capital/026n2cap'}]}
);
