...
officials.push(
    {id:350,name:'Salomón Jara Cruz',role:'Gobernador de Oaxaca (2022-2028)',party:'MORENA',state:'Oaxaca',level:'estatal',active:true,status:'en_funciones',
    scores:{sentencias:5,fiscalizacion:14,funcionarios:10,deuda:8,denuncias:10,evasion:6,nepotismo:15},
    breakdown:{sentencias:'Sin proceso penal formal. Excaliado Benjamín Robles Montoya (PT) lo llamó "criminal" y lo acusó de financiar campañas locales con dinero de "huachicol", sin presentar pruebas formales.',
    ...
    timeline:[{year:'2022',event:'Asume gubernatura de Oaxaca ("Primavera Oaxaqueña")'},{year:'2025',event:'La Jornada documenta al menos 20 funcionarios con parentesco directo con el gobernador'},{year:'2026',event:'Enero: consulta de revocación de mandato, 38% pide su salida. Febrero: "reestructuración" de gabinete que solo reacomoda a la misma red familiar.'}],
    sources:[{label:'Proceso — Reestructuración de gabinete',url:'https://www.proceso.com.mx/nacional/estados/2026/2/18/salomon-jara-ajusta-su-gabinete-tras-acusaciones-de-nepotismo-consulta-de-revocacion-de-mandato-366610.html'},{label:'La Jornada — 20 funcionarios con parentesco',url:'https://www.jornada.com.mx/noticia/2026/02/18/estados/salomon-jara-anuncia-cambios-en-su-gabinete-tras-acusaciones-de-nepotismo-y-jornada-de-revocacion-de-mandato'},{label:'MCCI — Revocación de mandato',url:'https://contralacorrupcion.mx/revocacion-de-mandato-en-oaxaca-entre-el-abstencionismo-y-las-acusaciones-de-fraude/'},{label:'Primera Línea — Sucesión y nepotismo',url:'https://www.primeralinea.mx/2025/03/25/sucesion-oaxaquena-en-2028-se-perfila-como-un-ajuste-de-cuentas-para-jara-nace-el-tucos-en-ciudad-de-mexico/'}]}
);


officials.push(
    {id:351,name:'Ruth Miriam González Silva',role:'Senadora de la República / Esposa del Gobernador de San Luis Potosí',party:'PVEM',state:'San Luis Potosí',level:'federal',active:true,status:'en_funciones',
    scores:{sentencias:5,fiscalizacion:12,funcionarios:8,deuda:11,denuncias:10,evasion:5,nepotismo:15},
    breakdown:{sentencias:'Sin proceso penal directo, pero señalada por periodistas potosinos como promotora de denuncias penales contra al menos 8 periodistas (incluida Anahí Torres González, directora de En Primera) por difundir un video cuestionado sobre su esposo.',
    ...
    timeline:[{year:'2015',event:'Presidenta del DIF municipal de Soledad de Graciano Sánchez con su esposo como alcalde'},{year:'2021',event:'Presidenta honoraria del DIF estatal cuando su esposo asume gubernatura'},{year:'2024',event:'Asume como senadora por San Luis Potosí (PVEM)'},{year:'2025',event:'Diciembre: Congreso de SLP aprueba "Ley Esposa" (reforma de paridad señalada como diseñada para ella)'},{year:'2026',event:'Enero: su esposo veta la reforma tras rechazo nacional. Mayo-julio: es destapada oficialmente como candidata a sucederlo en 2027 en medio de señalamientos de nepotismo y persecución a periodistas.'}],
    sources:[{label:'Proceso — Destape y críticas de nepotismo',url:'https://www.proceso.com.mx/nacional/2026/7/11/entre-nepotismo-y-acarreados-el-gobernador-de-slp-presenta-a-su-esposa-para-sucederlo-375876.html'},{label:'Crónica de Tierra Blanca — UIF \$724.6M y periodistas',url:'https://cronicadetierrablanca.com/rumbo-a-2027-ricardo-gallardo-destapa-a-su-esposa-ruth-gonzalez-como-candidata-a-la-gubernatura-de-san-luis-potosi/'},{label:'Wikipedia — Ley Esposa',url:'https://es.wikipedia.org/wiki/Ruth_Gonz%C3%A1lez_Silva'}]}
);


officials.push(
    {id:352,name:'Alfredo Ramírez Bedolla',role:'Gobernador de Michoacán (2021-presente)',party:'MORENA',state:'Michoacán',level:'estatal',active:true,status:'en_funciones',
    scores:{sentencias:8,fiscalizacion:8,funcionarios:14,deuda:6,denuncias:10,evasion:6,nepotismo:10},
    breakdown:{sentencias:'Sin proceso penal directo contra él. Su tío, Adalberto Fructuoso Comparán Rodríguez ("El Fruto"), fue sentenciado a 11 años de prisión en EE.UU. por tráfico de metanfetaminas para Cárteles Unidos. Su primo hermano, Adalberto Comparán Bedolla, sentenciado a 10 años por el mismo delito.',
...
officials.push(
    {id:356,name:'Delfina Gómez Álvarez',role:'Gobernadora del Estado de México (2023-presente)',party:'MORENA',state:'Estado de México',level:'estatal',active:true,status:'en_funciones',
    scores:{sentencias:6,fiscalizacion:18,funcionarios:12,deuda:14,denuncias:9,evasion:5,nepotismo:5},
    breakdown:{sentencias:'Sin proceso penal formal vigente. Denunciada en 2018 por el PAN (con cheques firmados como evidencia) por enriquecimiento ilícito, peculado y abuso de autoridad durante su gestión como alcaldesa de Texcoco.',
    ...
    timeline:[{year:'2015',event:'Alcaldesa de Texcoco. Denuncias posteriores por desvío de $55.5M del fondo de ahorro de empleados.'},{year:'2018',event:'PAN presenta denuncia con cheques firmados por ella como evidencia de financiamiento irregular a Morena'},{year:'2021',event:'Titular de la SEP federal. ASF deja pendiente esclarecer $830M de la Cuenta Pública 2021.'},{year:'2023',event:'Asume gubernatura del Estado de México, primera mujer en el cargo'},{year:'2026',event:'Marzo: se denuncia red de +300 plazas docentes fantasma. Junio: 10 exfuncionarios con órdenes de aprehensión, 5 detenidos.'}],
    sources:[{label:'El Heraldo — Confirma investigación',url:'https://heraldodemexico.com.mx/nacional/2026/4/15/confirma-delfina-gomez-investigacion-por-ventas-de-plazas-en-educacion-ratifica-lucha-contra-corrupcion-796838.html'},{label:'TOJIL — ASF \$830M SEP',url:'https://corruptometro.tojil.org/auditorias-arrojan-mas-de-830-millones-manejados-irregularmente-en-la-sep-con-delfina-gomez/'},{label:'El Heraldo — 10 exfuncionarios detenidos',url:'https://heraldodemexico.com.mx/nacional/2026/6/24/caen-10-exfuncionarios-por-venta-de-300-plazas-docentes-en-edomex-838382.html'},{label:'MCCI — Diezmos y desvíos',url:'https://contralacorrupcion.mx/cuentasclaras/delfina-y-pavlovich-historias-de-diezmos-y-desvios'}]}
);


officials.push(
    {id:357,name:'Rocío Nahle García',role:'Gobernadora de Veracruz (2024-presente)',party:'MORENA',state:'Veracruz',level:'estatal',active:true,status:'en_funciones',
    scores:{sentencias:8,fiscalizacion:16,funcionarios:8,deuda:13,denuncias:10,evasion:6,nepotismo:5},
    breakdown:{sentencias:'Sin proceso penal formal. Como secretaria de Energía (2018-2023) fue señalada por enriquecimiento ilícito y conflicto de interés.',
    ...
    timeline:[{year:'2018',event:'Asume Secretaría de Energía federal bajo AMLO'},{year:'2023',event:'Deja el cargo federal en medio de señalamientos por conflicto de interés y contratos a Marina Vitela'},{year:'2024',event:'Diciembre: asume gubernatura de Veracruz. Declara deuda heredada de $119,388M.'},{year:'2025',event:'Mayo: denuncia a administrador de Salud por daño patrimonial. Junio-octubre: Sheinbaum defiende a Cuitláhuac ante solicitudes de la ASF/ORFIS.'},{year:'2026',event:'Marzo: ORFIS documenta $241M en irregularidades en tres obras deportivas/turísticas heredadas. Abril: refinancia deuda, logra ahorro de $155M.'}],
    sources:[{label:'La Silla Rota — Críticas y deuda heredada',url:'https://lasillarota.com/veracruz/reportajes/2026/3/10/las-criticas-de-nahle-obras-pendientes-que-heredo-del-gobierno-de-cuitlahuac-589829.html'},{label:'LatinUS — Toma de posesión entre acusaciones',url:'https://latinus.us/mexico/2024/12/1/rocio-nahle-asume-hoy-la-gubernatura-de-veracruz-entre-acusaciones-de-corrupcion-polemicas-patrimoniales-129600.html'},{label:'Diario Gráfico — Denuncias por desfalcos',url:'https://graficoaldia.mx/2026/04/29/reduccion-de-deuda-y-denuncias-por-desfalcos-desatan-ira-y-frustracion-de-cuitlahuistas/'}]}
);
